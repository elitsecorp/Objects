...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "elicorp.pilot", "elicorp.pilot.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "elicorp.pilot", "elicorp.pilot.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "elicorp.pilot.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static boolean _vvvvvvvvv2 = false;
...
_vvvvvvvvv2 = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 35;BA.debugLine="B4XPages.Delegate.Activity_ActionBarHomeClick";
mostCurrent._vvvvvvvvvvvv4._v6 /*elicorp.pilot.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ ();
 //BA.debugLineNum = 36;BA.debugLine="ActionBarHomeClicked = False";
_vvvvvvvvv2 = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 37;BA.debugLine="End Sub";
return "";
}
public static String  _activity_create(boolean _firsttime) throws Exception{
elicorp.pilot.b4xpagesmanager _pm = null;
 //BA.debugLineNum = 25;BA.debugLine="Sub Activity_Create(FirstTime As Boolean)";
 //BA.debugLineNum = 26;BA.debugLine="Dim pm As B4XPagesManager";
_pm = new elicorp.pilot.b4xpagesmanager();
...
if (true) return mostCurrent._vvvvvvvvvvvv4._v6 /*elicorp.pilot.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (_keycode);
...
mostCurrent._vvvvvvvvvvvv4._v6 /*elicorp.pilot.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
...
mostCurrent._vvvvvvvvvvvv4._v6 /*elicorp.pilot.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (_permission,_result);
...
mostCurrent._vvvvvvvvvvvv4._v6 /*elicorp.pilot.b4xpagesdelegator*/ ._activity_resume /*String*/ ();
...
mostCurrent._vvvvvvvvvvvv4._v6 /*elicorp.pilot.b4xpagesdelegator*/ ._create_menu /*String*/ (_menu);
...
supabase_functions._process_globals();
