...
_query = "select * from FDM where icao_code = '"+_this_ap+"' order by year Desc, month desc, frequency desc";
...
_query = "select * from FDM where fdm_event = '"+_this_fdm+"' order by year Desc, month desc, frequency desc";
